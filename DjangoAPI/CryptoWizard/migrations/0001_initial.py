# Generated by Django 4.0.4 on 2022-05-14 01:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_plan', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='CryptoWizard.plan')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follow_user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='CryptoWizard.wizarduser')),
            ],
        ),
        migrations.CreateModel(
            name='Price',
            fields=[
                ...
                ('price_token_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='CryptoWizard.token', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Password',
