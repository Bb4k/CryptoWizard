# Generated by Django 4.0.4 on 2022-05-19 01:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_dob', models.DateField(blank=True, null=django.db.models.deletion.SET_NULL)),
                ('user_last_access', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follow_token_sym', models.CharField(max_length=5)),                ('follow_user_id', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='CryptoWizard.wizarduser')),
            ],
        ),
        migrations.CreateModel(
            name='Price',
